...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gmso-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10982&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gmso-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gmso` can be installed with:

```
conda install gmso
```

It is possible to list all of the versions of `gmso` available on your platform with:
